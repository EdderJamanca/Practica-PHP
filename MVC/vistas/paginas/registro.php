	...
	<form class="p-5 bg-light" method="post">
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input type="email" class="form-control" id="emailingreso" name="registroEmail">
		...
		$registro = ControladorFormulario::ctrRegistro();
			...
			if($registro == "error"){
				...
				echo '<div class="alert alert-success">No es permitido ingresar caracter especiales</div>';
			}
