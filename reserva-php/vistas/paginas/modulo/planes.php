...
<!-- 
			<div class="grid-item d-none d-lg-block" data-toggle="modal" data-target="#modalPlanes">
				...
				<img src="vistas/img/luna-de-miel.png" class="img-fluid" width="100%">
			...
			<div class="grid-item d-none d-lg-block" data-toggle="modal" data-target="#modalPlanes">
				...
				<img src="vistas/img/plan-aventura.png" class="img-fluid" width="100%">
			...
			<div class="grid-item d-none d-lg-block" data-toggle="modal" data-target="#modalPlanes">
				...
				<img src="vistas/img/plan-spa.png" class="img-fluid" width="100%">
