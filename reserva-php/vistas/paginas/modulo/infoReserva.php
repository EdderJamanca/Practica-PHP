<?php 
	if(isset($_POST["id-habitacion"])){
		...
		$reservas=ReservaControlador::ctlReservas($valor);
		...
		if(!$reservas){
			...
			$reservas=HabitacionControlador::ctlHabitacion($valor);
		...
		$planes=PlanControlador::ctlPlan();
		...
		if($hoy["mon"]==12 && $hoy["mday"]>=15 && $hoy["mday"]<=31 ||
		   ...
		   $hoy["mon"]==7 && $hoy["mday"]>=1 && $hoy["mday"]<=15){
		    ...
		    $precioRomantico=$reservas[$indice]["americano_alta"] + $planes[0]["precio_alto"];
		    $precioLunaDeMiel=$reservas[$indice]["americano_alta"]+ $planes[1]["precio_alto"];
		    $precioAventura=$reservas[$indice]["americano_alta"] + $planes[2]["precio_alto"];
		    $precioSPA=$reservas[$indice]["americano_alta"] + $planes[3]["precio_alto"];
		...
		<div class="row">
					...
					<h6 class="float-right px-3">
						...
						<?php if (isset($_SESSION["ValidarSession"])): ?>
							...
							<?php if ($_SESSION["ValidarSession"]=="ok"): ?>
								...
								<br>
						        <a href="perfil" style="color:#FFCC29">Ver tus reservas</a>
				...
				<div class="bg-white p-4 calendarioReservas">
					...
					<?php if ($valor == $_POST["ruta"]): ?>
						...
						<?php else: ?>
							...
							<div class="infoDisponibilidades"></div>
					...
					<form action="<?php echo $ruta; ?>reserva" method="POST">
						...
						<input type="hidden" name="id-habitacion" method="<?php echo $_POST["id-habitacion"]; ?>">
						...
						<div class="container mb-3">
							...
							<div class="row py-2" style="background:#509CC3">
								 ...
								 <div class="col-6 col-md-3 input-group pr-1">
									...
									<input type="text" class="form-control datepicker entrada" name="fecha-ingreso" value="<?php echo $_POST["fecha-ingreso"]; ?>" placeholder="Entrada">
							 	...
							 	<div class="col-6 col-md-3 input-group pl-1">
									...
									<input type="text" class="form-control datepicker salida" placeholder="Salida" name="fecha-salida" value="<?php echo $_POST["fecha-salida"]; ?>">
			...
			<div class="col-12 col-lg-4 colDerReservas" style="display:none">
				...
				<div class="form-group">
				  ...
				  <input type="text" class="form-control" value="Habitación <?php echo $reservas[$indice]["tipo_c"]." ".$reservas[$indice]["estilo"] ?>" readonly>

				  <?php 
				  		$imagen=json_decode($reservas[$indice]["galeria"]);
				   ?>

				  <img src="<?php echo $servidor.$imagen[0]; ?>" class="img-fluid">
				...
				<div class="form-group">
				  ...
				  <select class="form-control elegirPlan">
					...
					<option value="<?php echo $precioRomantico; ?>,Plan Romántico">Plan Romántico <?php echo number_format($precioRomantico) ?> 1 día 1 noche </option>
						...
						<?php if (isset($_SESSION["ValidarSession"])): ?>
							...
							<?php if ($_SESSION["ValidarSession"]=="ok"): ?>
								...
								<a href=" <?php echo $ruta;?>perfil" class="pagarReserva" 
									idHbitacion="<?php echo $reservas[$indice]["id_h"]; ?>"
									imgHabitacion="<?php echo $servidor.$imagen[0] ?>"
									infoHabitacion="Habitación <?php echo $reservas[$indice]["tipo_c"]." ".$reservas[$indice]["estilo"] ?>"
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title text-uppercase">Habitación <?php echo $reservas[$indice]["tipo_c"]." ".$reservas[$indice]["estilo"]; ?> </h4>
			...
			<div class="modal-body">
				...
				<figure class="text-center">
					<img src="<?php echo $servidor.$imagen[$indice]; ?>" class="img-fluid">
				</figure>
				...
				<div class="row">
					...
					<?php foreach ($planes as $key => $value): ?>
						...
						<div class="col-12 col-md-6">
							...
							<p class="px-2"> <?php echo $value["descripcion"]; ?> </p>

							<h4 class="px-2">Precio por parejas</h4>

							<p class="px-2">
								
	       				Temporada Baja: Plan Americano + $ <?php echo number_format($value["precio_bajo"]); ?> PEN<br>

	       				Temporada Alta: Plan Americano + $ <?php echo number_format($value["precio_alto"]); ?> PEN
							</p>
