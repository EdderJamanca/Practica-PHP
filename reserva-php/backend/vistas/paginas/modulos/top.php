...
$sumaVenta=ControladorInicio::ctrSumarVenta();

/*=============================================
Totar Reservas
=============================================*/

$totalReservas=ReservaControlador::ctrMostrarReserva(null, null);
/*=============================================
Totar Usuario
=============================================*/
$totalUsuario=UsuarioControlador::ctrMostrarUsuarios(null, null);
/*=============================================
Totar Testimonio
=============================================*/

$totalTestimonio=TestimonioControlador::ctrMostrarTestimonio(null, null);
...
<div class="col-12 col-sm-6 col-lg-3">
  ...
  <div class="small-box bg-info">
    ...
    <div class="inner">
      ...
      <h3>$ <span><?php echo number_format($sumaVenta["total"], 2, ",", "."); ?></span></h3>
...
<div class="col-12 col-sm-6 col-lg-3">
  ...
  <div class="small-box bg-dark">
    ...
    <div class="inner">
      ...
      <h3><?php echo count($totalUsuario); ?></h3>
...
<div class="col-12 col-sm-6 col-lg-3">
  ...
  <div class="small-box bg-secondary">
    ...
    <div class="inner">
      ...
      <h3><?php echo count($totalTestimonio); ?></h3>
